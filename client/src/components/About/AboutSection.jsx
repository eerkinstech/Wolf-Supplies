            ...
            <div className="max-w-6xl mx-auto space-y-12">
                ...
                <div className="mb-12">
                    <h2 className="text-4xl md:text-5xl font-bold mb-6" style={{ color: 'var(--color-text-primary)' }}>
                        Wolf Supplies Ltd - Online Retailer
                    </h2>
                    <p className="text-lg leading-relaxed" style={{ color: 'var(--color-text-secondary)' }}>
                        <span style={{ color: 'var(--color-text-primary)', fontWeight: 'bold' }}>Wolf Supplies Ltd</span> (Company Number: 16070029) is a UK-based online retailer offering a selection of products
                ...
                <div className="mb-12">
                    <h3 className="text-3xl font-bold mb-6" style={{ color: 'var(--color-text-primary)' }}>
                        Shopping with Wolf Supplies Ltd
                    </h3>
                    <p className="text-lg leading-relaxed" style={{ color: 'var(--color-text-secondary)' }}>
                        <span style={{ color: 'var(--color-text-primary)', fontWeight: 'bold' }}>Wolf Supplies Ltd</span> offers a selection of products for home and professional use. We provide product information, competitive pricing, secure payment processing through Stripe, free UK shipping, and a 31-day returns policy.
                    </p>
                </div>
