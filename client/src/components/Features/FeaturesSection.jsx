                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {features.map((feature) => {
                        ...
                        return (
                            <div
                                key={feature.id}
                                className="flex flex-row items-center gap-6 hover:scale-105 transition-transform duration-300 p-4 border border-gray-300 rounded-lg "
                            >
                                <div className="flex-shrink-0">
                                    {/* Icon */}
                                    <div className="p-4 bg-gray-200 rounded-lg flex items-center justify-center w-16 h-16">
