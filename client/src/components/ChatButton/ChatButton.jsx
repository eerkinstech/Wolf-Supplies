    ...
    return (
        <>
            ...
            {isChatOpen && (
                ...
                >
                    {/* Chat Header */}
                    <div className="bg-[var(--color-accent-primary)] text-white p-4 rounded-t-lg flex justify-between items-center">
                        <div>
                        ...
                        <div className="flex gap-2">
                            {!showUserForm && !isEditingInfo && (
                                <button
                                    ...
                                    className="text-white hover:bg-[var(--color-accent-light)] rounded-full p-2 transition duration-300"
                    ...
                    {showUserForm || isEditingInfo ? (
                        <div className="flex-1 overflow-y-auto p-4 bg-gray-50 flex flex-col justify-center">
                            <form onSubmit={showUserForm ? handleStartChat : (e) => { e.preventDefault(); handleSaveInfo(); }} className="space-y-4">
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-[var(--color-accent-primary)] text-white rounded-lg px-4 py-2 text-sm hover:bg-[var(--color-accent-light)] transition duration-300 font-semibold"
                                >
                            ...
                            <form onSubmit={handleSendMessage} className="space-y-2">
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-accent-primary)]"
                                        disabled={sending}
                                    />
                                    <button
                                        type="submit"
                                        className="bg-[var(--color-accent-primary)] text-white rounded-lg px-4 py-2 text-sm hover:bg-[var(--color-accent-light)] transition duration-300 disabled:opacity-50"
                                        disabled={sending}
                                    >
                                        {sending ? '...' : 'Send'}
                                    </button>
            ...
            <button
                onClick={toggleChat}
                className="fixed bottom-6 right-6 w-16 h-16 bg-[var(--color-accent-primary)] text-white rounded-full flex items-center justify-center shadow-2xl hover:bg-[var(--color-accent-light)] transition-all duration-300 z-[9999] hover:scale-110 transform pointer-events-auto"
                title="Open chat"
