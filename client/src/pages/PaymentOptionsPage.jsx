    ...
    const paymentMethods = [
        {
            ...
            icon: <span className="text-3xl font-bold text-blue-600">Visa</span>,
            ...
            cards: [
                { name: 'Visa', icon: <span className="text-2xl font-bold text-blue-600">Visa</span> },
                { name: 'Mastercard', icon: <span className="text-2xl font-bold text-red-600">Mastercard</span> },
                { name: 'Discover', icon: <span className="text-2xl font-bold text-orange-500">Discover</span> }
            ]
        },
        {
            id: 2,
            name: 'Apple Pay',
            icon: <span className="text-3xl font-bold text-black">Apple Pay</span>,
        ...
        },
        {
            id: 3,
            name: 'Google Pay',
            icon: <span className="text-3xl font-bold text-blue-500">Google Pay</span>,
            ...
            <div className="max-w-7xl mx-auto px-4">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-blue-50 border border-blue-200 rounded p-4">
                                        <p className="text-sm text-blue-900">
                                            <strong><i className="fas fa-lock inline mr-2"></i>Secure:</strong> All payments are encrypted and processed securely. Your financial information is never stored on our servers.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="bg-white rounded-lg shadow-lg p-8 mb-12 border border-gray-200">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-8">
                        <div className="text-center">
                            <i className="fas fa-lock" style={{ fontSize: '48px', color: '#2563eb', display: 'block', marginBottom: '12px' }}></i>
                        ...
                        <div className="text-center">
                            <i className="fas fa-circle-check" style={{ fontSize: '48px', color: '#16a34a', display: 'block', marginBottom: '12px' }}></i>
                        ...
                        <div className="text-center">
                            <i className="fas fa-shield" style={{ fontSize: '48px', color: '#dc2626', display: 'block', marginBottom: '12px' }}></i>
                ...
                <div className="bg-white rounded-lg shadow-lg p-8 mb-12 border border-gray-200">
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        <div className="text-center">
                            <i className="fas fa-circle-check text-4xl text-green-600 mx-auto mb-3" style={{ display: 'block' }}></i>
                        ...
                        <div className="text-center">
                            <i className="fas fa-lock text-4xl text-blue-600 mx-auto mb-3" style={{ display: 'block' }}></i>
                        ...
                        <div className="text-center">
                            <i className="fas fa-shield text-4xl text-red-600 mx-auto mb-3" style={{ display: 'block' }}></i>
                        ...
                        <div className="text-center">
                            <i className="fas fa-circle-check text-4xl text-purple-600 mx-auto mb-3" style={{ display: 'block' }}></i>
