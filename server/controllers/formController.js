...
export const assignConversation = async (req, res) => {
  try {
    ...
    const conversation = await ContactSubmission.findOneAndUpdate(
      { conversationId },
      { assignedTo: adminId },
      { new: true }
    ).populate('assignedTo', 'name email');
...
export const deleteConversation = async (req, res) => {
  try {
    ...
    await ContactSubmission.findOneAndDelete({ conversationId });
...
export const deleteMessage = async (req, res) => {
  try {
    ...
    const conversation = await ContactSubmission.findOne({ conversationId });
